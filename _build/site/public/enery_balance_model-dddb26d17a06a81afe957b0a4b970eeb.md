...
$$
\int_{0}^{\pi}d\theta \int_{\phi_0}^{\phi_0 + \delta \phi}d\phi \frac{r^2\sin(\phi)S_0|\cos(\phi)|}{\pi r\sin(\phi_0)\cdot r\delta \phi} = \frac{S_0}{{\pi \sin(\phi_0)\cdot \delta \phi}} \int_{0}^{\pi}d\theta \int_{\phi_0}^{\phi_0 + \delta \phi}d\phi\sin(\phi)|\cos(\phi)|
$$
which gets us:
\begin{align*}
    &= \frac{S_0}{\sin(\phi _0)} [-\cos(2\phi)]_{\phi_0}^{\phi_0 + \delta \phi} \\
    &= S_0 (\cos(2\phi_0)-\cos(2(\phi_0 + \delta\phi))) \\
    &= S_0 \left[ \cos(2\phi_0) - (\cos(2\phi_0)\cos(2\delta \phi) - \sin(2\phi_0)\sin(2\delta \phi))\right]
\end{align*}
Now we take the limit as $\delta\phi \to 0$, we get 
