...
That being said, we are coding up the solver for educational purposes(that's also why AI can replace software engineering but can't replace typing up code by hand, since coding itself is a very rewarding learning process), therefore 
