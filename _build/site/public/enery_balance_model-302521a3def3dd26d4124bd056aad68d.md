...
:::[warning]
The following snippets takes quite some time to run, please open a jupyter server to proceed with the computation as the free binder service is not quite sufficient. 
:::
