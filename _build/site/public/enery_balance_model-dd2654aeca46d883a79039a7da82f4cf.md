...
:::{prf:proposition} Radiative Forcing as $$
The 
:::
...
&= \lim_{\delta \phi \to 0} \frac{\int_{0}^{\pi} d\theta \int_{\phi_0}^{\phi_0+\delta \phi} d\phi r^2\sin(\phi)|\cos\phi|}{\int_{0}^{\pi} d\theta \int_{\phi_0}^{\phi_0+\delta \phi} d\phi  r^2 \sin(\phi)}
\end{align*}
which gets us:
\begin{align*}
