...
then the $n$ equations can be reorganized in to a linear system in the form $y' = Ay +b$:
...
At a parituclar $T(t, \phi_i)$, we have the approximation(just a first order taylor approximation)

$$ \sigma  T^4 = \approx  (4\sigma T(t, \phi_i)^3) T - 3\sigma T(t, \phi_i) $$
