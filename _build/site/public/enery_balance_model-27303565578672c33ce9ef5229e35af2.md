...
:::{warning}
The following snippets takes $\~1\text{minute}$ run, please open a jupyter server to proceed with the computation as the free binder service is not quite sufficient. 
:::
