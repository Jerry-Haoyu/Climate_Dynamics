...
[^tf]: The figure, which I created in pages, aims to represent a GCM. I'm trying to do some data-driven appraoch to come up with a toy GCM, supervised by Professor Gan. However things are just starting. 