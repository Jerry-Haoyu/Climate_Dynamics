...
tracing the temperature at a particular latitude as time marches on. Generally, imagine $T(t,\phi)$ being a surface, we are taking cross sections that are parallel to the time axis
