...
This now seems to be much more realistic! The same data is used to create the animation at the start of this note.


### Pathological Polar Temperature: Numerical Artifact or Model Insufficiency? Need to find out
