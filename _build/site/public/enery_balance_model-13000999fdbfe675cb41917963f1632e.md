...
Let's define:
$$
\alpha_i = \frac{\cos \phi_i}{4\Delta t^2}
$$
and 
$$
\beta_i = \frac{\cos \phi_{i+1} + \cos \phi_{i-1}}{2\Delta t^2}
$$
Then the system Of ODE obtained from semidiscretization of the 1d EBM would be:

$$\frac{dT}{dt} = \begin{pmatrix}
    \purple{\beta_0} & 0 & \alpha_{2} & & & &  \\ 
    0 & \purbeta_1 & 0 & \alpha_{3} & & &  \\ 
    \alpha_0 & 0 & \beta_0 & 0 & \alpha_{4} & &   \\ 
    & \ddots & \ddots & \ddots & \ddots &\ddots  & \\
    & &\alpha_{N-5} &0 &\beta_{N-3} & 0 & \alpha_{N-1} \\
    & & &\alpha_{N-4} &0 & \beta_{N-2} & 0 \\
    & & & &\alpha_{N-3} & 0 & \beta_{N-1} 
\end{pmatrix}$$
:::
