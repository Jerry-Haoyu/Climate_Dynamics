...
$$
T_{t}(t,\phi_i) &= F(T(t, \phi_i)) -  T(\phi_{i+1} ,t) \left\{ \frac{D}{\Delta t2} - \frac{D\tan \phi_i}{2C\Delta t} \right\} \\
&+ T(\phi_i, t)\left\{ -\frac{2D}{\Delta t^2}\right\} \\
&+ T(\phi_{i+1},t)\left\{ \frac{D}{\Delta t2} + \frac{D\tan \phi_i}{2C\Delta t} \right\}
$$
...
\frac{dT}{dt} = 
\begin{pmatrix}
-\frac{2D}{\Delta t^2} & \left(\frac{D}{\Delta t2} - \frac{D\tan \phi_i}{2C\Delta t}\right)  & 0 & \cdots & \cdots & 0  \\ 
\left(\frac{D}{\Delta t2} + \frac{D\tan \phi_i}{2C\Delta t}\right) &  -\frac{2D}{\Delta t^2} & \left(\frac{D}{\Delta t2} - \frac{D\tan \phi_i}{2C\Delta t}\right) & 0 & \cdots & 0  \\
0 & \left(\frac{D}{\Delta t2} + \frac{D\tan \phi_i}{2C\Delta t}\right) &   -\frac{2D}{\Delta t^2}  & \left(\frac{D}{\Delta t2} - \frac{D\tan \phi_i}{2C\Delta t}\right) & \cdots  & 0 \\
