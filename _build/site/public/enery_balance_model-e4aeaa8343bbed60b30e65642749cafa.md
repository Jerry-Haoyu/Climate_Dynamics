...
We discretize the spatial dimension : $[\phi_1, \phi_2,....,\phi_N]$ where $N$ is the number of subcell we divide the 1DLet's use the following finite difference scheme:

$$
T_{\phi} \approx \frac{T(\phi_{}, t)}{2\Delta t}
$$
