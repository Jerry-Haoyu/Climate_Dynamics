...
$$
where $D=\{\theta, \phi : \pi/2\leq \phi\leq \pi/2, 0 \leq \theta \leq \pi\}$

:::{tip}**ToolBox** Double Integral in Spherecial Coordinate 
$r^2 \sin\phi d\phi d\theta $ is the surface element, since a surface element has $$dS = (r\sin\phi)d\theta \cdot r\d\phi)
:::
