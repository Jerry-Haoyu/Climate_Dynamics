...
As a result, eigenvalues of $(I-Adt)^{-1}$ has magnitude less than 1 for all positve step size $dt$ provided that all eigenvalues of $A$ are negative. In otherword, stability is always acheived no matter how small the step-size is. This is known as **unconditional stability**.
