...
- In this case, we use the so called **line method** where we discretize the spatial dimension. The result is a system of ODE. Intuitively, imagine a surface $T(t,\phi)$