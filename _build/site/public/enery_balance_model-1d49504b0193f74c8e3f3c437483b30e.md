...
[^nbc]: Technically we can flow through the pole, however, as all trajectories converge to a single point(which is measure-zero), there is essentially no area 
