...
$$
T_t(t, \phi_i) = \frac{\cos \phi_{i+1}}{4\Delta \phi^2}T(t, \phi_{i+2})  
- 2 \frac{\cos \phi_{i+1} + \cos \phi_{i-1}}{4\Delta \phi^2}  T(t, \phi_{i})   +  \frac{\cos \phi_{i-1}}{4\Delta \phi^2}T(t, \phi_{i-2}) + S_0 |\cos \phi | - \sigma T^4
$$
:::