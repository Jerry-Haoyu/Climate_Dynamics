...
$$
\int_{0}^{\pi}d\theta \int_{\phi_0}^{\phi_0 + \delta \phi}d\phi \frac{r^2\sin(\phi)S_0|\cos(\phi)|}{\pi r\sin(\phi_0)\cdot r\delta \phi} = \frac{S_0}{{\pi \sin(\phi_0)\cdot \delta \phi}} \int_{0}^{\pi}d\theta \int_{\phi_0}^{\phi_0 + \delta \phi}d\phi\sin(\phi)S_0|\cos(\phi)|
$$
which gets us:
\begin{align*}
    &= S_0 [-\cos(2\phi)]_{\phi_0}^{\phi_0 + \delta \phi} \\
    &= S_0 (\cos(2\phi_0)-\cos(2(\phi_0 + \delta\phi))) \\
    &= S_0 \pi r^2\left[ \cos(2\phi_0) - (\cos(2\phi_0)\cos(2\delta \phi) - \sin(2\phi_0)\sin(2\delta \phi))\right]
\end{align*}
