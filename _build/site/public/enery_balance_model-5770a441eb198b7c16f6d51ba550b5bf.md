...
This now seems to be much more realistic! The same data is used to create the animation at the start of this note. However at poles the temperature is way too cold. I suspect this is due to wrong implementation of the boundary condition. However, I haven't yet find out exactly why. 
