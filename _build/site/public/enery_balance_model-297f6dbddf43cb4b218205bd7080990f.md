...
$$
\int_{0}^{\pi}d\theta \int_{\phi_0}^{\phi_0 + \delta \phi}d\phi \frac{r^2\sin(\phi)S_0|\cos(\phi)|}{\pi r\sin(\phi_0)\cdot r\delta \phi} = \frac{S_0 \int_{0}^{\pi}d\theta \int_{\phi_0}^{\phi_0 + \delta \phi}d\phi\sin(\phi)S_0|\cos(\phi)|
$$
which gets us:
\begin{align*}
