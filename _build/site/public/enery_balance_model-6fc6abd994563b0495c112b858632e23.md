...
We can define subproblems as computing $T(t_j, \phi_i)$. To compute this, we need the result of a collection of other subproblems. In our heat equation, it is $T(t_{j-1}, \phi_{i+2}), T(t_{j-1}, \phi_{i+2}), T(t_{j-1}, \phi_{i+2})$
:::