...
Let the eigenvalues of $A$ be $\lambda_1,...,\lambda_n$, then the eigenvalues of $(I-Adt)^{-1}$(provided they exists) are $\frac{1}{1-\lambda_1dt},\frac{1}{1-\lambda_2},....,\frac{1}{1-\lambda_n}$
:::
