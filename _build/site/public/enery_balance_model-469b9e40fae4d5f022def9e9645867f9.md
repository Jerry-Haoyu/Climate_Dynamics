...
Let the eigenvalues of $A$ be $\lambda_1,...,\lambda_n$, then the eigenvalues of $(I-Adt)^{-1}$(provided they exists) are $\frac{1}{1-\lambda_1dt},\frac{1}{1-\lambda_2dt},....,\frac{1}{1-\lambda_n}$
:::

The proof is out of the scope of this course note, however, one can consider the special case when $A$ is diagonalizable : $A=P^{-1}DP$, then $(I-Adt)^{-1}= (I-PDdtP$
