...
- Intuitively, imagine a surface $T(t,\phi)$, we reduce into ODE by just focusing on one particular location $\phi'$ and trace the variation of temeprature at that spatial location. 